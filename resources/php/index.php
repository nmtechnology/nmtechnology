...
try {
	...
	$swiftMessage->setSubject("contact form was submitted");
	/**
	...
	echo "<div class=\"alert alert-danger\" role=\"alert\"><strong>Oh snap that didn't wor as planned!</strong> Unable to send email: " . $exception->getMessage() . " " . $exception->getFile() . "</div>";
}
