...
<div class="bg-gray-900 fixed z-40">
        <header class="w-screen sticky shadow-lg">
            <nav id="nav" class="flex-row sm:flex-row p-10 lg:px-8 flex -mx-20" aria-label="Global">
                <div class="px-16 flex -mt-8">
                    ...
                    <div class="flex lg:flex md:flex-1 sm:flex sm:-mx-10 gap-7 -m-4 grid-cols-7 w-full right-0 space-x-7">
