            ...
            >
              <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">
                  <span class="text-green-400">We're changing the way you are</span> <span class="text-green-400">protected and served</span> <span class="text-green-400">Right Here In</span> <img class="w-16 h-16" src="/public/images/zia-symbol.webp" alt="New Mexico Logo"></img>
