        ...
        <div class="mx-auto max-w-7xl px-6 pt-12 sm:pt-16 lg:px-8 lg:pt-20">
          <div class="flex justify-center mb-6">
            ...
            >
              ...
              <span class="text-sm font-semibold text-purple-400">Video Surveillance & CCTV</span>
            </div>
          </div>
          ...
          <!-- NMTech Bot Image with Purple Glow -->
