<template>
  <div class="root w-full">
    ...
    <button @click="navigateToProducts" class="inline-flex items-center justify-center px-3 py-1.5 bg-gray-700 border border-gray-600 rounded-md font-medium text-white text-sm hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-all duration-300">
