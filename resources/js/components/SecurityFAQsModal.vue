<template>
  <div class="root w-full">
    ...
    <button @click="openModal" class="inline-flex items-center justify-center px-3 py-1.5 bg-red-600 border border-red-500 rounded-md font-medium text-white text-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all duration-300">
