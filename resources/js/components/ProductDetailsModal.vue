<template>
  <div
    v-if="isOpen"
    class="product-details-modal-fixed"
      ...
      <div
        ...
        :class="[
          ...
          themeColor === 'green'
            ...
            : themeColor === 'purple'
            ? 'border-purple-600/30 theme-purple'
            : themeColor === 'blue'
            ? 'border-blue-600/30 theme-blue'
            : themeColor === 'yellow'
            ? 'border-yellow-600/30 theme-yellow'
            : 'border-transparent',
        ]"
      >
        ...
        >
          <div class="relative">
            ...
            <div
              ...
              class="relative bg-gray-900 border-b border-gray-700"
            >
                ...
                <div class="absolute inset-0 z-10 pointer-events-none">
                  ...
                  <div class="relative px-4 py-3 flex flex-col pointer-events-auto">
                    ...
                    <div class="flex justify-between items-center">
                      ...
                      <button
                        @click="close"
                        class="text-gray-300 hover:text-white focus:outline-none focus:ring-2 focus:ring-white/20 rounded-full p-1 transition-colors"
                      >
                    ...
                    <div class="flex gap-2 mt-2">
                      <span
                        class="inline-block text-white text-xs px-2 py-1 rounded-full bg-opacity-90"
                        :class="{
                    ...
                    <div
                      v-if="product.images && product.images.length > 1"
                      class="text-xs text-gray-300/80 mt-2"
                    >
                ...
                >
                  ...
                  >
                    <div class="w-full h-full flex items-center justify-center">
                      ...
                      <div
                        :class="[
                          'absolute inset-0 bg-gr flex items-center justify-center transition-opacity duration-300',
                          currentSlide === index ? 'opacity-100' : 'opacity-0',
                        ]"
                      >
                        <div
                          class="w-8 h-8 border-4 border-gray-600 border-t-gray-200 rounded-full animate-spin"
                        ></div>
                      </div>
                      <img
                        :src="image"
              ...
              <div
                class="flex justify-center pb-3 space-x-2"
                v-if="product.images.length > 1"
                role="tablist"
        ...
        <div class="bg-gray-800 px-4 py-3 sm:px-6 overflow-y-auto flex-grow scrollbar">
          ...
          <div v-if="product.specs" class="mt-8 border-t border-gray-700 pt-4">
            <h4 class="text-white font-medium mb-4">
              ...
              >
              <span
                v-else-if="product.category === 'security'"
                :class="`text-${themeColor}-500`"
                >Security System</span
              >
              <span
                v-else-if="product.brand === 'NM Solar'"
                :class="`text-${themeColor}-500`"
                >Solar Security</span
              >
              <span
                v-else-if="product.category === 'monitoring'"
                :class="`text-${themeColor}-500`"
                >Monitoring</span
              >
            ...
            >
              <h5 :class="`text-${themeColor}-500 font-semibold mb-2`">
                Complete Security Solution
              </h5>
              <p class="text-gray-300 text-sm">
                This package includes everything you need for a complete security setup:
                cameras, NVR, storage, and all necessary cables and mounting hardware.
            ...
            >
              ...
              <p class="text-gray-300 text-sm">
                This security system includes everything you need to protect your home:
                control panel, sensors, and mobile app access. Professional installation
            ...
            >
              <h5 :class="`text-${themeColor}-500 font-semibold mb-2`">
                Solar-Powered Security Solution
              </h5>
              <p class="text-gray-300 text-sm">
                This solar-powered security system can be deployed anywhere without
                requiring grid power. Perfect for remote locations, construction sites, or
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const handleTouchMove = (e) => {
      ...
      if (initialSwipeDirection === "horizontal") {
        ...
        if (carouselRef.value) {
          ...
          carouselRef.value.style.transform = `translateX(calc(-${
            currentSlide.value * 100
          }% + ${offset}px))`;
        }
      }
    };
      ...
      if (carouselRef.value) {
        ...
        if (isDragging && initialSwipeDirection === "horizontal") {
          ...
          if (Math.abs(deltaX) > swipeThreshold) {
            ...
            carouselRef.value.style.transition =
    ...
    const prevSlide = () => {
      if (!props.product.images) return;
      currentSlide.value =
        (currentSlide.value - 1 + props.product.images.length) %
    ...
    const announceSlideChange = () => {
      const announcement = `Image ${currentSlide.value + 1} of ${
    ...
    onMounted(() => {
      ...
      const handleKeyDown = (e) => {
        if (!props.isOpen || !props.product.images || props.product.images.length <= 1)
          return;
    ...
    const themeColor = computed(() => {
      if (props.product.category === "package") {
        ...
        props.product.category === "security" &&
        props.product.color === "blue"
      ) {
        return "blue";
