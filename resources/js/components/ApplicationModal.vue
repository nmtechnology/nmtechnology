                ...
                <div class="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p class="mt-2 text-gray-300">
                      Apply for a career opportunity at NM Technology
                    </p>
                  </div>
                </div>
                <button
              ...
              >
                ...
                <div class="bg-gray-800/50 p-6 rounded-lg border border-gray-700/50">
                  ...
                  <div class="space-y-4">
                    <div>
                      <label class="block text-sm font-medium text-gray-300 mb-2"
                        >Years of Experience in Security/Technology *</label
                      >
                      <select
                    ...
                    <div>
                      <label class="block text-sm font-medium text-gray-300 mb-2"
                        >Current/Previous Employment</label
                      >
                      <textarea
                ...
                <div class="bg-gray-800/50 p-6 rounded-lg border border-gray-700/50">
                  ...
                  <div>
                    <label class="block text-sm font-medium text-gray-300 mb-2"
                      >Why do you want to work at NM Technology? *</label
                    >
                    <textarea
                ...
                <div class="bg-gray-800/50 p-6 rounded-lg border border-gray-700/50">
                  ...
                  <div class="space-y-4">
                    ...
                    <div>
                      ...
                      <div
                        v-if="uploadStatus.resume"
                        class="mt-2 flex items-center text-sm"
                      >
                        <div
                          v-if="uploadStatus.resume === 'uploading'"
                        ...
                        <div
                          v-else-if="uploadStatus.resume === 'scanning'"
                        ...
                        <div
                          v-else-if="uploadStatus.resume === 'success'"
                        ...
                        <div
                          v-else-if="uploadStatus.resume === 'error'"
                    ...
                    <div>
                      ...
                      <div class="relative">
                        ...
                        <button
                          ...
                          class="w-full flex items-center justify-center px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-lg text-gray-300 hover:border-green-500 hover:bg-gray-700 transition-colors duration-300"
                          :class="{
                            'border-green-500 bg-gray-700': formData.coverLetterFile,
                          }"
                        >
                          <svg
                            class="h-5 w-5 mr-2"
                      ...
                      <div
                        v-if="uploadStatus.coverLetter"
                        class="mt-2 flex items-center text-sm"
                      >
                        <div
                          v-if="uploadStatus.coverLetter === 'uploading'"
                          class="flex items-center text-yellow-400"
                        >
                          <svg
                            class="animate-spin h-4 w-4 mr-2"
                        ...
                        <div
                          v-else-if="uploadStatus.coverLetter === 'scanning'"
                          class="flex items-center text-blue-400"
                        >
                          <svg
                            class="animate-pulse h-4 w-4 mr-2"
                        ...
                        <div
                          v-else-if="uploadStatus.coverLetter === 'success'"
                          class="flex items-center text-green-400"
                        >
                          <svg
                            class="h-4 w-4 mr-2"
                        ...
                        <div
                          v-else-if="uploadStatus.coverLetter === 'error'"
                          class="flex items-center text-red-400"
                        >
                          <svg
                            class="h-4 w-4 mr-2"
                    ...
                    <div class="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
                      <div class="flex items-start">
                        <svg
                          class="h-5 w-5 text-blue-400 mr-2 mt-0.5 flex-shrink-0"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
                        ...
                        <div class="text-sm">
                          ...
                          <p class="text-blue-200">
                            All uploaded documents are automatically scanned for viruses
                            and malware before being processed. Only clean, verified files
                ...
                <div class="bg-gray-800/50 p-6 rounded-lg border border-gray-700/50">
                  ...
                  <div class="space-y-4">
                    <div>
                      <label class="block text-sm font-medium text-gray-300 mb-2"
                        >Reference 1 (Name, Company, Phone, Email)</label
                      >
                      <textarea
                    ...
                    <div>
                      <label class="block text-sm font-medium text-gray-300 mb-2"
                        >Reference 2 (Name, Company, Phone, Email)</label
                      >
                      <textarea
                  ...
                  <div class="space-y-4">
                    <div>
                      ...
                      <div class="flex space-x-4">
                        <label class="flex items-center">
                          <input
                            v-model="formData.workAuthorized"
                            type="radio"
                            value="yes"
                            required
                            class="text-green-500 focus:ring-green-500 bg-gray-700 border-gray-600"
                          />
                    ...
                    <div>
                      ...
                      <div class="flex space-x-4">
                        <label class="flex items-center">
                          <input
                            v-model="formData.driversLicense"
                            type="radio"
                            value="yes"
                            required
                            class="text-green-500 focus:ring-green-500 bg-gray-700 border-gray-600"
                    ...
                    <div>
                      ...
                      <div class="flex space-x-4">
                        <label class="flex items-center">
                          <input
                            v-model="formData.felonyConviction"
                            type="radio"
                            value="yes"
                            required
                            class="text-green-500 focus:ring-green-500 bg-gray-700 border-gray-600"
...
export default {
  ...
  methods: {
    ...
    async submitApplication() {
      ...
      if (
        this.uploadStatus.resume === "uploading" ||
        this.uploadStatus.resume === "scanning"
      ) {
      ...
      if (
        this.formData.coverLetterFile &&
        (this.uploadStatus.coverLetter === "uploading" ||
          this.uploadStatus.coverLetter === "scanning")
      ) {
