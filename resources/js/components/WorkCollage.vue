<template>
  <div class="relative z-40">
    <!-- Section Header -->
    <h2
      class="text-white text-bold text-center text-4xl drop-shadow-lg animate-fadeIn mt-12 mb-6"
    >
      QSR Franchise Security Systems
    </h2>
    <p
      class="text-center text-gray-300 text-lg mb-10 animate-fadeIn-delay max-w-4xl mx-auto px-4"
    >
      Protecting restaurants, retail, and franchises across New Mexico with advanced CCTV
      and access control solutions.
    </p>

    <!-- Main Gallery - Modern Card-Based Layout -->
    <div
      class="relative container bg-gray-900/80 backdrop-blur-sm mx-auto mb-10 sm:mb-16 px-3 sm:px-6 lg:px-8 py-6 sm:py-8 rounded-xl shadow-xl"
    >
    ...
    <!-- Commercial Section -->
    <h2
      class="text-white text-bold text-center text-3xl md:text-4xl drop-shadow-lg animate-fadeIn mt-12 sm:mt-20 mb-4 sm:mb-6"
    >
      Commercial Retail CCTV
    </h2>
    <p
      class="text-center text-gray-300 text-base sm:text-lg mb-8 sm:mb-10 animate-fadeIn-delay max-w-4xl mx-auto px-4"
    >
    ...
    <!-- Fire Alarm Section -->
    <h2
      class="text-white text-bold text-center text-2xl sm:text-3xl md:text-4xl drop-shadow-lg mt-12 sm:mt-20 mb-4 sm:mb-6"
    >
    ...
    <!-- On-site Section -->
    <h2
      class="text-lime-400 text-bold text-center text-3xl md:text-4xl drop-shadow-lg mt-20 mb-8"
    >
    ...
    <!-- Bottom Section -->
    <section
      class="bg-gray-900/80 backdrop-blur-sm py-16 animate-fadeIn mt-12 rounded-lg"
    >
      <h2
        class="text-2xl md:text-3xl font-bold text-green-400 text-center mb-8 drop-shadow-lg"
      >
        CCTV Installation & Security Projects
      </h2>
      <p
        class="text-lg text-gray-300 text-center mb-10 animate-fadeIn-delay max-w-4xl mx-auto px-4"
      >
        NM Technology is Albuquerque's leader in
        <strong class="text-green-400">CCTV installation</strong>, security systems, and
        smart automation. Our portfolio showcases work for restaurants, retail, offices,
        and industrial sites across New Mexico.<br /><br />
        ...
        <strong>"CCTV installation Albuquerque"</strong> and related security services.
      </p>

      <h3 class="text-xl font-semibold text-lime-400 text-center mt-8 animate-fadeIn">
