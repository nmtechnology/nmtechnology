<template>
    <h6 class="text-lime-400 text-bold text-center text-4xl">QSR Franchise Security Systems</h6>
    <div class="container bg-gray-900 mx-auto mb-12 px-5 py-2 lg:px-32 lg:pt-24">
        ...
        <br>
        <br>
        <h1 class="text-bold text-lime-400 text-center text-4xl">Commercial Retail CCTV</h1>
        <br>
        <div class="-m-1 flex flex-wrap md:-m-2">
            <div class="flex w-1/2 flex-wrap">
                <div class="w-1/2 p-1 md:p-2">
