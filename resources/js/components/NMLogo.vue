<template>
  <div :class="containerClasses">
   <img src="/public/images/NM-logo-main.webp" class="h-16 w-16 sm:h-20 w-auto" alt="NM Technology Logo" />
    <div
...
const textClasses = computed(() => {
  ...
  const variantClasses = {
    ...
    mobile: ["italic", "font-extrabold", "text-white", "-ml-1", "whitespace-nowrap"],
    footer: [
      "italic",
      "font-extrabold",
      "text-white",
