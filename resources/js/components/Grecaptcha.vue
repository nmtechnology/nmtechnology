...
export default {
    ...
    data() {
        return {
            isRecaptchaVerfied: false,
        };
    },
    methods: {
        onRecaptchaVerified() {
            this.isRecaptchaVerfied = true;
        },
        submitForm() {
...
<div class="relative isolate bg-blue-950">
        <div class="flex justify-items-center">
            <div class="m-40">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-12 h-12 items-center">
  <path stroke-linecap="round" stroke-linejoin="round" d="M7.864 4.243A7.5 7.5 0 0119.5 10.5c0 2.92-.556 5.709-1.568 8.268M5.742 6.364A7.465 7.465 0 004.5 10.5a7.464 7.464 0 01-1.15 3.993m1.989 3.559A11.209 11.209 0 008.25 10.5a3.75 3.75 0 117.5 0c0 .527-.021 1.049-.064 1.565M12 10.5a14.94 14.94 0 01-3.6 9.75m6.633-4.596a18.666 18.666 0 01-2.485 5.33" />
                ...
                <div>
                    ...
                    <br>
                    <a href="/" class="offset-md-2 offset-lg-2 offset-sm-3 items-center">
                        <input class="justify-items-center cursor-not-allowed rounded-md bg-lime-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                            type="button" value="Get Started" data-expired-callback="enableBtn" :disabled="!isRecaptchaVerified" @click="submitForm"></a>
                </div>
                <div class="absolute left-1/2 right-0 top-0 -z-10 -ml-24 transform-gpu overflow-hidden blur-3xl lg:ml-24 xl:ml-48" aria-hidden="true">
                    <div class="aspect-[801/1036] w-[29.0625rem] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30"
