    ...
    <div class="justify-content-baseline">
        <div class="m-20">
            <div class="justify-content-start">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="lime" class="w-14 h-12 items-center">
                ...
                <div>
                    ...
                    <button data-sitekey="6LevCN0mAAAAAC2CnQAlJf1RlTYrZz9jCdlbDQ_8" data-callback="enableBtn" class="g-recaptcha justify-items-center rounded-md bg-lime-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                    ...
                    <div class="grid grid-cols-1absolute left-1/2 right-0 top-0 -z-10 -ml-24 transform-gpu overflow-hidden blur-3xl lg:ml-24 xl:ml-48" aria-hidden="true">
                        <div class="justify-items-center aspect-[801/1000] w-[20.0625rem] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30" style="clip-path: polygon(63.1% 29.5%, 100% 17.1%, 76.6% 3%, 48.4% 0%, 44.6% 4.7%, 54.5% 25.3%, 59.8% 49%, 55.2% 57.8%, 44.4% 57.2%, 27.8% 47.9%, 35.1% 90.5%, 0% 97.7%, 39.2% 100%, 35.2% 81.4%, 97.2% 52.8%, 63.1% 29.5%)"></div>
                    </div>
