...
<br><br><br><br><br><br>
  ...
  <div class="card-header">
    <h2 class="text-white">Security Systems</h2>
  </div>
  <div class="card-body">
    <h5 class="card-title container mb-5">Need To Secure Your Home Or Business?</h5>
  ...
  <p class="col-sm-12 col-md-12 col-lg-12 col-xxl-12 mt-5">If you need security systems, access control or security cameras installed on your property call us today for a free estimate.
                 ...
                 vulnerablilities that can render to your business. We 
                        ...
                        <br></p></div>
                        <div><a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Saira&size=35&pause=4000&color=ADFF00&width=435&lines=service%40nmtechnology.us" alt="Typing SVG" /></a><h3 class="col-md-4 offset-md-4 text-center">505-659-5097</h3> <p class="text-center">Our Technicians are licensed, bonded and certified professionals!</p></div>    
                        </div>
    
  <div class="card-footer text-muted">
  <img src="images/alarm-logo.png" class="col-2 col-xxl-1 col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-4 img-responsive" alt="nm-technology-low-voltage-albuquerque" width="75" height="75">
  <img src="images/bosch-logo.png" class="col-2 col-xxl-1 col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-4 img-responsive img-fluid" alt="nm-technology-low-voltage-albuquerque" width="10" height="60">
  <img src="images/fire-lite-logo.png" class="col-2 col-xxl-2 col-xl-2 col-lg-2 col-md-3 col-sm-3 col-xs-4 img-responsive" alt="nm-technology-low-voltage-albuquerque" width="5" height="60">
  <img src="images/z-wave-logo.png" class="col-2 col-xxl-1 col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-4 img-responsive" alt="nm-technology-low-voltage-albuquerque" width="10" height="60">
  <img src="images/qolsys-logo.png" class="col-2 col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-4 img-responsive" alt="nm-technology-low-voltage-albuquerque" width="30" height="60">
  </div>
</div>
    </section>
    <br><br><br>
    ...
    <div class="text-center box-back gx-5 container">
  <div class="card-header">
    <h2 class="text-white">CCTV Security Camera's</h2>
  </div>
  <div class="card-body">
    <h5 class="card-title container mb-5">We can watch and monitor your property with </h5>
    <div id="carouselExampleDark" class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 carousel carousel-fade " data-bs-ride="carousel">
  ...
  <p class="col-sm-12 col-md-12 col-lg-12 col-xxl-12 mt-5">We have tons of camera solutions for your every need.  </p>
                        <p>We offer Alarm.com packages at an affordable rate and we can beat your current monitoring price, we know
                         you will love the service and product experience from NM Technology!
                        <br></p></div>
