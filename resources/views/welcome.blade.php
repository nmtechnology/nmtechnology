...
<div class="img-fluid">
    ...
    <section class="mt-5 gx-sm-4">
            ...
            <br><br><br><br><br>
            <!-- <div class="container-fluid offset-xxl-0 offset-xl-3 offset-lg-4">

<svg xmlns="http://www.w3.org/2000/svg" width="116" height="116" fill="white" class="bi bi-house-exclamation-fill offset-xxl-2 offset-xl-0 offset-lg-4" viewBox="0 0 16 16">
  ...
  <div class="offset-xxl-6 offset-xl-2"><svg width="300px" height="175px" version="1.1">
    <path fill="transparent" stroke="#888888" stroke-width="4" d="M10 80 Q 77.5 10, 145 80 T 280 80" class="path"></path>
</svg><div class="ball"></div></div><svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="white" class="bi bi-cloud-check-fill offset-xxl-3 offset-xl-3 offset-lg-0" viewBox="0 0 16 16">
  <path d="M8 2a5.53 5.53 0 0 0-3.594 1.342c-.766.66-1.321 1.52-1.464 2.383C1.266 6.095 0 7.555 0 9.318 0 11.366 1.708 13 3.781 13h8.906C14.502 13 16 11.57 16 9.773c0-1.636-1.242-2.969-2.834-3.194C12.923 3.999 10.69 2 8 2zm2.354 4.854-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7 8.793l2.646-2.647a.5.5 0 0 1 .708.708z"/>
</svg>
<svg xmlns="http://www.w3.org/2000/svg" width="116" height="116" fill="white" class="bi bi-phone-vibrate col-xxl-9" viewBox="0 0 16 16">
